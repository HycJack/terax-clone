                        ...
                        matching the visual convention from VSCode. */}
									...
									{tabs.length > 1 && (
										<span
											...
											className="flex size-5 items-center justify-center rounded-sm opacity-0 transition-opacity hover:bg-accent hover:opacity-100 group-hover:opacity-60"
										>
											<HugeiconsIcon
												icon={Cancel01Icon}
												size={11}
							...
							const tabNode =
								t.kind === "terminal" ? (
									<ContextMenu>
										...
										<ContextMenuContent className="min-w-32 p-1">
											<ContextMenuItem
